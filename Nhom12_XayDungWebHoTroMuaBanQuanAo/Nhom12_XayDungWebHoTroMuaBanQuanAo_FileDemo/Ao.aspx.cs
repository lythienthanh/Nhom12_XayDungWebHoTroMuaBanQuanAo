...
public partial class Ao : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "ÁO THUN SỌC NGANG");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN CÀ RỐT");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN IN TEXT");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN DA BEO");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN FORM RỘNG");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN MÀU TRƠN");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO HAI DÂY MÀU ");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO CROPTOP IN HÌNH NHỎ");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO CROPTOP CỔ TIM");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN CROP TOP MÀU");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO THUN IN TEXT NHỎ");
        Session.Add("ChatLieu", "Thun");
        Session.Add("MauSac", "Hồng ,Trắng ,Vàng");
        Session.Add("Size", "Vừa cân nặng < 55kg");
        Session.Add("masp", 01);
