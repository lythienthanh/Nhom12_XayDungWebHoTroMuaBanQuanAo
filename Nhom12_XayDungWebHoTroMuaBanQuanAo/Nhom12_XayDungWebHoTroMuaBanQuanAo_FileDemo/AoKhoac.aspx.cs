...
public partial class AoKhoac : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "ÁO KHOÁC HOẠ TIẾT SAU");
        Session.Add("ChatLieu", "Phi bóng ");
        Session.Add("MauSac", "Xanh rêu");
        Session.Add("Size", "Vừa cân nặng < 60kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO KHOÁC THÊU TEXT");
        Session.Add("ChatLieu", "Phi bóng ");
        Session.Add("MauSac", "Xanh rêu");
        Session.Add("Size", "Vừa cân nặng < 60kg");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "ÁO KHOÁC TÚI LỚN");
        Session.Add("ChatLieu", "Phi bóng ");
        Session.Add("MauSac", "Xanh rêu");
        Session.Add("Size", "Vừa cân nặng < 60kg");
        Session.Add("masp", 01);
