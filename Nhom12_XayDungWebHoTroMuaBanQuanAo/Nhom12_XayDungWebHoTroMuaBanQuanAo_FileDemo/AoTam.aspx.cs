...
public partial class AoTam : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "BNIKINI IN TEXT");
        Session.Add("ChatLieu", "Thun lạnh ");
        Session.Add("MauSac", "Đen");
        Session.Add("Size", "M vừa cân nặng từ 45kg-48kg L vừa cân nặng từ 49kg-52kg");
        Session.Add("masp", 01);
