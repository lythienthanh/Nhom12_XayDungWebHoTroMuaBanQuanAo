...
public partial class TuiBong : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "TÚI HÌNH THÚ CƯỜI");
        Session.Add("ChatLieu", "Bông");
        Session.Add("MauSac", "Hồng");
        Session.Add("Size", "Ngang  20.5cm x Cao 29cm x Rộng 9cm");
        Session.Add("masp", 01);
