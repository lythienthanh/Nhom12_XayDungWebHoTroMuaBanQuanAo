...
public partial class TuiCoTrung : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "TÚI CỠ TRUNG DÂY MIX MÀU");
        Session.Add("ChatLieu", "Vải bố");
        Session.Add("MauSac", "Đen, Be, Trắng");
        Session.Add("Size", "Ngang 27cm x Cao 28cm x Rộng 10cm");
        Session.Add("masp", 01);
