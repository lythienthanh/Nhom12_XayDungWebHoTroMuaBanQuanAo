...
public partial class TuiDeoCheo : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "TÚI ĐEO CHÉO MIX MÀU");
        Session.Add("ChatLieu", "Vải bố");
        Session.Add("MauSac", " Đen, Kem, Vàng");
        Session.Add("Size", "Ngang 35cm x  Cao 38cm x Rộng 1cm ");
        Session.Add("masp", 01);
    ...
    {
        Session.Add("Ten", "TÚI VAI HÌNH VỊT");
