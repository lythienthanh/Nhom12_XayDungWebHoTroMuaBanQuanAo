...
public partial class Vi : System.Web.UI.Page
{
    ...
    {
        Session.Add("Ten", "VÍ MINI ICON");
        Session.Add("ChatLieu", "Da");
        Session.Add("MauSac", "Xanh da trời, Xám , Hồng, Xanh ngọc ");
        Session.Add("Size", "Ngang 10.5cm x Cao 8cm x Rộng 3cm");
        Session.Add("masp", 01);
